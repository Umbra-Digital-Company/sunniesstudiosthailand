! function(t) {
  function e(e) {
      for (var i, r, n = e[0], v = e[1], l = e[2], p = 0, u = []; p < n.length; p++) r = n[p], Object.prototype.hasOwnProperty.call(o, r) && o[r] && u.push(o[r][0]), o[r] = 0;
      for (i in v) Object.prototype.hasOwnProperty.call(v, i) && (t[i] = v[i]);
      for (_ && _(e); u.length;) u.shift()();
  ...
  20: function(t, e, a) {
          ...
          t && (0, i.default)(e).addClass("loading-icon"), i.default.ajax({
              ...
              a.html(r), s.find(".btn-cart__counter").text(n), (0, i.default)(e).removeClass("loading-icon"), f(), (0, i.default)(".cart-drawer .cart-widget__item").length ? ((0, i.default)(".cart-progress").show(), (0, i.default)(".cart-drawer").removeClass("cart-drawer__empty"), function() {
                  ...
                  (0, i.default)(".cart-progress-bar__filled").css({
                      ...
                      ? ((0, i.default)(".cart-progress-status").addClass("complete").removeClass("incomplete").text("Congrats! You get free shipping ✨"), (0, i.default)(".cart-widget .cart-widget__total.shipping .cart-widget__total-value").text("Computed at checkout")) 
                      : ((0, i.default)(".cart-progress-status").addClass("incomplete").removeClass("complete").text("ADD $" + (100 - e) + " MORE TO GET FREE SHIPPING"), (0, i.default)(".cart-widget .cart-widget__total.shipping .cart-widget__total-value").text("Computed at checkout")) // $20
      ...
      function v() {
          ...
          i.default.ajax({
              ...
              var a = (0, i.default)(".js-cart-section "),
                  ...
                  p = (0, i.default)(e).find(".item-counter").text();
              (0, i.default)(e).find(".cart-item--static").length ? (s.html(v), d()) : a.html(n), r.find(".btn-cart__counter").text(p), (0, i.default)(t).removeClass("loading-icon"), (new o.default).init(), l(), _(), c(500, 3e3)
          })).fail((function() {
      ...
      function u(t, e) {
          var a = setInterval((function() {
                  if (console.log("Processing: Checking for dcode info..."), (0, i.default)("#dcodeInfo").length) {
                      ...
                      t.text("$" + p(_)), (0, i.default)(".discount-value-placeholder").length && (0, i.default)(".discount-value-placeholder").remove(), (0, i.default)("#dcodeInfo").append('<p class="discount-value-placeholder">-&nbsp;$' + p(s) + "</p>"), (0, i.default)(".dcDiscountBox button").on("click", (function() {
                          t.text("$" + p(r + l))
                      }))
                  }
              }), t),
      ...
      function c(t, e) {
          var a = setInterval((function() {
                  console.log("Processing: Waiting for dcode element"), (0, i.default)("#dcodeOuterWrapper").length && (console.log("Success: Dcode element is ready"), u(500, 1e4), clearInterval(a), o = !0, (0, i.default)("#dcodeSubmit").on("click", (function() {
                      "" !== (0, i.default)("#dcodeInput").val() && (console.log("applying code in progress..."), u(1e3, 1e4), setTimeout((function() {
                          o || clearInterval(a)
                      }), 5e3))
                  })), (0, i.default)("#dcodeInput").on("keydown", (function(t) {
                      "Enter" == t.key && (console.log("applying code in progress..."), u(1e3, 1e4), setTimeout((function() {
                          o || clearInterval(a)
                      }), 5e3))
                  })))
              }), t),
      ...
      function d() {
          ...
          (0, i.default)(".cart-progress-bar__filled").css({
              width: a + "%"
          }), e >= 100 ? ((0, i.default)(".cart-progress-status").addClass("complete").removeClass("incomplete").text("Congrats! You get free shipping ✨"), (0, i.default)(".cart-static--shipping").text("Computed at checkout")) : ((0, i.default)(".cart-progress-status").addClass("incomplete").removeClass("complete").text("ADD $" + (100 - e) + " MORE TO GET FREE SHIPPING"), (0, i.default)(".cart-static--shipping").text("Computed at checkout")) //
      }
              ...
              return (0, o.default)(t, [{
                  ...
                  value: function() {
                      ...
                      var n = function(e) {
                          ...
                          _ = void 0;
                      try {
                          for (var p, u = i[Symbol.iterator](); !(v = (p = u.next()).done); v = !0) n(p.value)
                      } catch (t) {
                          l = !0, _ = t
                      } finally {
                          try {
                  ...
                  value: function(t) {
                      var e = this.variants,
                          ...
                          p = Number(t.dataset.variantId),
                          u = e.filter((function(t) {
                              return t.id === p
                          }))[0],
                          c = this.formattedPrice(u.price),
                          d = this.formattedPrice(u.compare_at_price),
                          f = document.getElementById("dittoDisplay"),
                          m = window.location.href.split("?")[0] + "?variant=" + p;
                      ...
                      t.classList.add("selected"), n.innerText = u.option1, l.dataset.handleName = u.option1.toLowerCase().trim().replace(/\s/, "-"), u.available ? (v.classList.remove("unavailable"), this.availableButton(!0)) : (v.classList.add("unavailable"), this.availableButton(!1)), document.querySelector(this.price).innerText = c, document.querySelector(this.comparePrice).innerText = "$0" === d ? "" : d, this.sliders.rebuildSlick(u.images), document.querySelector(this.formVariant).value = p, f && a.addUpdateSlide(u)
                  }
              }, {
                  key: "initDescription",
                  value: function() {
                      var t = this,
                          e = document.querySelector(this.tablist).querySelectorAll("button");
                      ...
                      function a(a) {
                          a.addEventListener("click", (function() {
                              ...
                              var p = !0,
                                  ...
                                  c = void 0;
                              try {
                                  for (var d, f = e[Symbol.iterator](); !(p = (d = f.next()).done); p = !0) d.value.classList.remove("active")
                              } catch (t) {
                                  u = !0, c = t
                              } finally {
                                  try {
                  ...
                  value: function(t) {
                      ...
                      r.default.post("/cart/add.js", e).then((function(t) {
                          return (0, _.default)(!0), a.classList.add("expanded"), (0, p.default)(), (0, s.default)("html").addClass("no-scroll"), c = (0, s.default)(window).scrollTop(), (0, s.default)("body").attr("data-top", (0, s.default)(window).scrollTop()).css("top", -c), !0
                      })).catch((function(t) {
          ...
          return (0, o.default)(t, [{
              ...
              value: function(t) {
                  var e = this.scanId,
                      ...
                      c = "",
                      d = Ditto.flowType;
                  _.classList.add("hide"), v ? c = v : ((c = document.createElement("div")).id = "dittoDisplay", c.style.height = p.offsetHeight + "px"), (0, s.default)(l).slick("slickAdd", c, 0, "addBefore"), console.log(d), "COMPATIBILITY" == d && (document.querySelector("#DittoPopup").style.display = "none"), "" === e || r ? (u.classList.add("active"), this.createTryOnView("#DittoPopup", t.sku), (0, s.default)(l).slick("slickGoTo", 0)) : (this.displayTryOnFrontal("#dittoDisplay", t.sku, e), (0, s.default)(l).slick("slickGoTo", 0))
              }
          }, {
              key: "createTryOnView",
              value: function(t, e) {
                  ...
                  e.toggleLoader(), setTimeout((function() {
                      ...
                      try {
                          for (var v, l = t[Symbol.iterator](); !(i = (v = l.next()).done); i = !0) {
                              var _ = v.value,
                                  p = r.default.html(_.alt, _.url);
                              (0, s.default)(a).slick("slickAdd", p)
                          }
                      } catch (t) {
                          o = !0, n = t
                      } finally {
      ...
      var n = {
          init: function(t) {
              ...
              return (0, o.default)(i.default.mark((function a() {
                  var o, s, r, n, v, l, _, p, u, c, d;
                  return i.default.wrap((function(e) {
                      for (;;) switch (e.prev = e.next) {
                          case 0:
                              o = JSON.parse(document.getElementById("ShopifyData").innerHTML), s = o.product, r = o.customer, n = JSON.parse(document.getElementById("PrescriptionCMSData").innerHTML), v = n.lenses, l = n.cms, _ = n.buttons, p = Number(document.querySelector(".js-variant-id").value), u = s.variants.filter((function(t) {
                                  return t.id === p
                              ...
                              })), s.selectedVariant = u, t.dispatch("getPrescriptions", r), t.commit("setCms", l), t.commit("setFrame", s), t.commit("setLenses", v), t.commit("setOptionMeta", d), t.commit("setNonPrescriptionLens", c);
                          case 14:
                          case "end":
                              return e.stop()
                      }
          ...
          return (0, o.default)(t, [{
              ...
              value: function(t) {
                  var e = t.variants[0],
                      ...
                      i = a ? "Out of Stock" : "",
                      o = e.compare_at_price && e.compare_at_price > e.price ? "product-item--sale" : "",
                      s = o ? "Sale" : "",
                      r = t.tags.includes("prescription") || t.tags.includes("Prescription") ? "" : '<a href="#" class="btn-quick-add js-quick-add"><span></span>Quick Add</a>',
                      n = "",
                      v = "",
                      l = "",
                      _ = "",
                      ...
                      c = void 0;
                  try {
                      for (var d, f = t.variants[Symbol.iterator](); !(p = (d = f.next()).done); p = !0) {
                          var m = d.value,
                              h = m.id === e.id ? 'class="current-swatch-variant"' : "",
                              y = m.available ? "" : "data-swatch-disabled",
                              b = "";
                          m.id === e.id && (b = ' class="current-image-variant"'), v += '<span style="font-size: 14px; color: #b3a89b !important;" data-vid-color="' + m.id + '" id="item_color_name_' + t.title + '" class="' + (m.id === e.id ? "current-color-name" : "") + '">' + m.option1 + "</span>", _ += '<p class="product__prices-item ' + (m.id === e.id ? "current-price-variant" : "") + '" data-vid-price="' + m.id + '">' + x(m) + "</p>", l += "<li " + h + " " + y + '><a class="js-product-item-swatch" data-swatch-vid="' + m.id + '" data-swatch-style="' + t.title + '" href="#"><span data-handle-name="' + m.option1.toLowerCase().replace(/ /g, "-") + '"></span></a></li>', m.featured_image && (n += '<span data-bg-src="' + m.featured_image.src + '" data-image-variant="' + m.id + '" style="background-image: url(' + m.featured_image.src + ');"' + b + "></span>")
                      }
                  } catch (t) {
                      u = !0, c = t
                  } finally {
                  ...
                  var g = '<ul class="list-swatches list-swatches--plp">' + l + "</ul>";
      ...
      e.default = {
          ...
          methods: Object.assign({}, (0, r.mapMutations)(["setActiveLenses", "setPrescription", "setFinalLens", "setFinalVariant", "setStep", "setFrameOptions", "setGrabPrescriptions"]), {
              ...
              addToCart: function() {
                  ...
                  new n.default(e).addLens(), this.$emit("add-to-cart"), (0, p.default)(!0), document.querySelector(".cart-drawer").classList.add("expanded")
              },
              ...
              formatPrescriptionStore: function(t, e) {
                  var a = t.toLowerCase(),
                      i = (0, u.default)(e).format("YYYYMMDD");
              ...
              formIsValid: function() {
                  ...
                  var n = !0,
                      ...
                      _ = void 0;
                  try {
                      for (var p, u = e[Symbol.iterator](); !(v = (p = u.next()).done); v = !0)
                          if (p.value.value.length < 1) {
                              n = !1;
                              break
                          }
                  } catch (t) {
              ...
              filterLensesByGroup: function(t, e) {
                  ...
                  if (this.activePrescription.type = t, a.step1.name = "Vision: " + t[0].toUpperCase() + t.slice(1), a.step1.cost = "free", a.step2.cost = 0, a.step3.cost = 0, this.imposeGroupLimits(o, t), this.setActiveLenses(i), "grab-prescription" == e) {
                      var r = (0, s.default)(".gp-button.active").data("prx-right-sph"),
                          ...
                          p = (0, s.default)(".gp-button.active").data("prx-right-ph"),
                          u = (0, s.default)(".gp-button.active").data("prx-left-sph"),
              ...
              return (0, r.default)(t, [{
                  ...
                  value: function() {
                      this.add(this.frameId, this.frameProps).then((function() {
                          return (0, _.default)(!0), document.querySelector(".cart-drawer").classList.add("expanded"), (0, p.default)(), (0, n.default)("html").addClass("no-scroll"), c = (0, n.default)(window).scrollTop(), (0, n.default)("body").attr("data-top", (0, n.default)(window).scrollTop()).css("top", -c), !0
                      })).catch((function(t) {
                          return window.alert(t)
                      }))
                  }
